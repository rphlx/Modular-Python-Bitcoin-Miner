...
from .boardproxy import rphUSBBoardProxy
...
class rphUSBWorker(BaseWorker):
  
  version = "rph.usb worker v0.0.1"
  default_name = "Untitled rph USB worker"
  ...
  def __init__(self, core, state = None):
    ...
    super(rphUSBWorker, self).__init__(core, state)
  ...
  def apply_settings(self):
    ...
    super(rphUSBWorker, self).apply_settings()
  ...
  def _reset(self):
    # Let our superclass handle everything that isn't specific to this worker module
    super(rphUSBWorker, self)._reset()
  ...
  def _start(self):
    # Let our superclass handle everything that isn't specific to this worker module
    super(rphUSBWorker, self)._start()
  ...
  def main(self):
    ...
    while not self.shutdown:
      try:
        ...
        self.proxy = rphUSBBoardProxy(proxy_rxconn, proxy_txconn, self.serial,
